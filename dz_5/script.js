...
// главное, чтобы ключей было больше, чем значений.
// если вдруг ключей будем больше, то просто получим в значении undefined
// если ключей будем меньше, потеряем значения
if (en.length < ru.length) {
    console.log('слишком мало данных :(');
} else {
